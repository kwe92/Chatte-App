...
class FireStoreService {
  ...
  static CollectionReference<Map<String, dynamic>> _returnCollection(
          {required FirebaseFirestore firestore, required String collectionPath}) =>
...
//TODO: Maybe shorten the implementation a bit an need to make descending optional
  static Query<Map<String, dynamic>> _returnCollectionOrdered(
          {required CollectionReference<Map<String, dynamic>> collectionRef, required String orderBy, bool descending = true}) =>
  ...
  static Stream<QuerySnapshot<Map<String, dynamic>>> _returnCollectionSnapshot(
          {required CollectionReference<Map<String, dynamic>> collectionRef, String? orderBy}) =>
      orderBy == null ? collectionRef.snapshots() : _returnCollectionOrdered(collectionRef: collectionRef, orderBy: orderBy).snapshots();
  ...
  static Stream<List<QueryDocumentSnapshot<Map<String, dynamic>>>> _returnListDocsSnapshot(
  ...
  Stream<List<Map<String, dynamic>>> getListDocsData({required String collectionPath, String? orderBy}) =>
      FireStoreService._returnListDocsData(
        documentSnapshots: _returnListDocsSnapshot(
          snapshot: _returnCollectionSnapshot(
            collectionRef: _returnCollection(
              firestore: FireStoreService._firebaseFirestore,
