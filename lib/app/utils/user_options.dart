...
// Retrieve a single user by id
  static Future<DocumentSnapshot<Map<String, dynamic>>> getUser({required collection, required userid}) async =>
      await FirebaseFirestore.instance.collection(collection).doc(userid).get();

// Delete a message given the currently logged in user
  static Future<void> deleteMessage({required String id, required String path}) async {
